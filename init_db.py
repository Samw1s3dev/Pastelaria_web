#!/usr/bin/env python3
"""
Script para inicializar o banco de dados da Pastelaria Web
Este script deve ser executado uma vez para configurar o banco de dados
"""
...
def init_database():
    ...
    with app.app_context():
        ...
        admin = Cliente(
            nome='VenturasDev',
            telefone='42999700315',
            endereco='Endereço administrativo',
            is_admin=True,
            consentimento_lgpd=True
        )
        admin.set_senha('8102@sarutneV')  # Senha padrão - deve ser alterada em produção
        ...
        print("   📱 Telefone: 42999700315")
        print("   🔑 Senha: 8102@sarutneV")
